...
Sensor sensor=new Sensor(1,"motion sensor","powered",599,"quarax",15);
...
Sensor sensor1=new Sensor(2,"wall mount","powered",789,"rushwak",9);
...
Sensor sensor2=new Sensor(3,"automatic in night time","energy efficient",2959,"vrprime",20);
...
Sensor sensor3=new Sensor(4,"bis","cell",1800,"medtronic",20);
...
Sensor sensor4=new Sensor(5,"motion","powered",1995,"askon",150);
