package com.xworlz.softwarehub;

import com.xworlz.softwarehub.application.Application;
import com.xworlz.softwarehub.softwarehub.SoftwareHub;
...
public class ApplicationEx {
    public static void main(String[] args) {
        ...
        for(int index=0;index<size;index++) {
            ...
            application.setVersion(sc.nextInt());
